  ...
  const values = [
    {
      ...
      title: "Precision",
      description: "Meticulous attention to detail ensures every project meets the highest quality standards."
    },
    {
      icon: <Heart className="w-6 h-6" />,
      title: "Passion",
      description: "Driven by a love for print craftsmanship, we deliver exceptional results."
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: "Partnership",
      description: "Building lasting relationships through collaboration and understanding client needs."
    },
    {
      icon: <Eye className="w-6 h-6" />,
      title: "Innovation",
      description: "Embracing cutting-edge technology to stay ahead in the printing industry."
    }
  ];
      ...
      <section className="relative bg-gray-900 py-24 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto mb-16 font-light leading-relaxed">
            Pioneering printing and packaging excellence since 1995. We don't just print; we create brand experiences that leave a lasting impression.
          </p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-6xl mx-auto mt-12">
            {stats.map((stat, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-colors duration-300">
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="relative rounded-[3rem] overflow-hidden shadow-2xl group">
            ...
            <div className="absolute bottom-12 left-6 md:left-12 max-w-2xl">
                <span className="inline-block px-4 py-1 bg-white/20 backdrop-blur-md text-white rounded-full text-sm font-medium mb-4 border border-white/30">Established 1995</span>
          ...
          <div className="mt-16 grid lg:grid-cols-2 gap-12 items-start pb-24">
            <p className="text-2xl md:text-3xl text-gray-900 font-medium leading-tight">
              Pushti Pack has been redefining the standards of offset printing for nearly three decades.
            </p>
            <div className="space-y-6 text-lg text-gray-600 font-light">
              <p>
                From our humble beginnings, we have evolved into a technology-driven powerhouse, serving the most demanding industries including Pharmaceuticals, FMCG, and Luxury Cosmetics. 
              </p>
              <p>
                Our philosophy is simple: combine artisanal craftsmanship with industrial-scale efficiency. Today, we are proud to be the trusted partner for global brands seeking sustainable and high-impact packaging solutions.
              </p>
              <Link to="/contact" className="inline-flex items-center gap-2 font-semibold text-gray-900 hover:gap-4 transition-all group pt-4">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div className="max-w-xl">
                ...
                <p className="text-gray-600 text-lg">The foundation of every project we undertake and every partnership we build.</p>
            </div>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {values.map((value, index) => (
              <div key={index} className="p-8 bg-white border border-gray-100 rounded-3xl hover:border-gray-900 transition-all duration-300 group">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">The Partners</h2>
            <p className="text-gray-500 text-lg">Leading with experience and innovation</p>
          </div>
            ...
            {team.map((member, index) => (
              <div key={index} className="group relative">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-gray-500 font-semibold tracking-widest uppercase text-xs">{member.role}</p>
                    <p className="text-gray-600 text-lg font-light leading-relaxed pt-2">{member.description}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-3 gap-8">
            {certifications.map((cert, index) => (
              <div key={index} className="relative group p-10 bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2.5rem] hover:bg-white/10 transition-all">
                <div className={`w-16 h-16 bg-gradient-to-br ${cert.color} rounded-2xl flex items-center justify-center mb-8 text-white shadow-lg`}>
                  {cert.icon}
                </div>
                <h3 className="text-2xl font-bold text-white mb-2">{cert.title}</h3>
                <p className="text-gray-400 font-medium tracking-wide uppercase text-xs mb-4">{cert.subtitle}</p>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-gray-900 rounded-[3rem] p-12 md:p-24 relative overflow-hidden text-center">
            ...
            <h2 className="text-4xl md:text-6xl font-bold text-white mb-8 relative z-10">Ready to transform your brand?</h2>
