  ...
  const packagingMachines = [
    {
      ...
      description:
        "High-speed automatic folding machine for pharmaceutical and FMCG cartons with precision gluing system. This machine offers unmatched accuracy and rapid production rates, minimizing waste and maximizing throughput for complex folding requirements.",
      specifications: [
    ...
    },
    {
      ...
      description:
        "Versatile packaging line capable of handling multiple formats including bottles, tubes, and sachets. This system is designed for flexibility in co-packing environments, offering rapid tool-less changeovers between product lines.",
      specifications: [
    ...
    },
    {
      ...
      description:
        "Precision blister packaging solution for tablets, capsules, and medical devices with GMP compliance. Features high-precision forming and sealing for optimal product protection and shelf life.",
      specifications: [
    ...
    },
    {
      ...
      description:
        "Advanced shrink wrapping system for secondary packaging with energy-efficient heating tunnel. Provides tight, professional wrapping for product bundles and cartons.",
      specifications: [
  ...
  const printingMachines = [
    {
      ...
      description:
        "High-performance 8-color offset printing press with perfecting capabilities for premium quality output. Renowned for its rapid makeready and exceptional print consistency.",
      specifications: [
    ...
    },
    {
      ...
      description:
        "State-of-the-art 4-color offset press with LED-UV curing and automated quality control systems. Delivers vibrant, high-quality results on a variety of substrates.",
      specifications: [
    ...
    },
    {
      ...
      description:
        "High-resolution digital printing solution for short to medium run label production with variable data capability. Perfect for custom, on-demand label jobs.",
      specifications: [
        "Print Width: 330mm",
    ...
    },
    {
      ...
      description:
        "Advanced flexographic press for high-quality printing on flexible packaging materials with quick job changeover. Suitable for films, foils, and paper stocks.",
      specifications: [
        "Print Width: 850mm",
        "Colors: Up to 10",
        "Speed: 300 m/min",
