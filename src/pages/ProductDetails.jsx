            ...
            <div className="space-y-8">
              ...
              <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  <p>
                    <strong>Phone:</strong> +91 9427611985
                  </p>
                  <p>
                    <strong>Email:</strong>{" "}
                    <a
          ...
          <div className="max-w-4xl mx-auto">
            ...
            {activeTab === "overview" && (
              <div className="space-y-8 animate-fadeIn p-8 bg-white rounded-2xl shadow-xl border border-gray-200">
                <div className="text-center">
                  <h2 className="text-3xl font-bold text-gray-900 mb-6 border-b pb-4 border-gray-100">
                    Product Overview
                  </h2>
                  <p className="text-lg text-gray-600 leading-relaxed max-w-3xl mx-auto">
                    {product.description} Our {product.name.toLowerCase()} are
                    designed with precision and manufactured using
                    state-of-the-art technology to meet the highest industry
                    standards.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
                  <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 border border-gray-200 shadow-sm">
                    ...
                    <ul className="space-y-3 text-gray-700">
                      ...
                      <li className="flex items-start">
                        <ChevronRight className="w-4 h-4 text-gray-900 mr-3 mt-1 flex-shrink-0" />
                        Highly competitive pricing without compromising on
                        quality
                      </li>
                    </ul>
                  </div>
              ...
              <div className="space-y-6 animate-fadeIn p-8 bg-white rounded-2xl shadow-xl border border-gray-200">
                ...
                <div className="grid gap-4">
                  {product.specifications.map((spec, index) => (
                    <div
                      key={index}
                      className="bg-gray-50 rounded-xl shadow-sm border border-gray-100 p-5 hover:bg-gray-100 transition-colors duration-300"
                    >
            ...
            {activeTab === "benefits" && (
              <div className="space-y-6 animate-fadeIn p-8 bg-white rounded-2xl shadow-xl border border-gray-200">
                <div className="text-center">
                  ...
                  <p className="text-lg text-gray-600 mb-8">
                    Discover the advantages of choosing our **{product.name}**
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {product.benefits.map((benefit, index) => (
                    <div
                      key={index}
                      className="bg-gray-50 rounded-xl shadow-md border border-gray-100 p-6 hover:shadow-lg transition-all duration-300 group"
                    >
                      <div className="flex items-start">
            ...
            {activeTab === "applications" && (
              <div className="space-y-8 animate-fadeIn p-8 bg-white rounded-2xl shadow-xl border border-gray-200">
                <div className="text-center">
                  ...
                  <p className="text-lg text-gray-600 mb-8">
                    Explore the various industries and applications where our **
                    {product.name}** excel.
                  </p>
                </div>
                ...
                <div className="bg-gray-50 rounded-xl p-8 text-center border border-gray-200 mt-8">
                  ...
                  <p className="text-gray-700 mb-6">
                    Don't see your specific application listed? We specialize in
                    custom solutions tailored to unique industry requirements.
                  </p>
                  <Link
                    to="/contact"
      ...
      <section className="py-24 bg-gray-900 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-10 font-light leading-relaxed">
            Contact us today for a personalized quote for **
            {product.name.toLowerCase()}**. Our experts are ready to help bring
            your vision to life.
          </p>
