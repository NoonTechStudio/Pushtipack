    ...
    },
    {
      ...
      children: [
        ...
        { name: "Corrugated Boxes", href: "/products#corrugated-boxes" },
        {
          ...
          href: "/products#promotional-material",
        },
      ],
    },
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <span className="flex items-center opacity-70">
              <MapPin className="w-3 h-3 mr-2" /> Vadodara, Gujarat
            </span>
          </div>
        </div>
      </div>
            ...
            <nav className="hidden lg:flex items-center gap-12">
              {navigation.map((item, idx) => (
                ...
                >
                  <Link
                    to={item.href}
                    className={`flex items-center text-sm font-medium tracking-wide transition-colors py-3 ${
                      isActive(item.href)
                        ? "text-black"
                  ...
                  >
                    ...
                    {item.children && (
                      <ChevronDown
                        className={`w-3 h-3 ml-1 transition-transform duration-300 ${activeDropdown === idx ? "rotate-180" : ""}`}
                      />
                    )}
                  </Link>
                  ...
                  {item.children && (
                    <div
                      className={`absolute top-full -left-4 w-60 pt-2 transition-all duration-300 origin-top-left ${
                        activeDropdown === idx
      ...
      >
        ...
        {/* Drawer */}
        <div
          className={`absolute right-0 top-0 h-full w-[80%] max-w-sm bg-white shadow-2xl transition-transform duration-500 ease-out transform ${
              ...
              {navigation.map((item, idx) => (
                ...
                >
                  <Link
                    ...
                    className={`text-2xl font-light tracking-tight block mb-3 ${
                      isActive(item.href)
