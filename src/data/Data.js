...
export const productData = {
  'mono-cartons': {
    ...
    description: 'High-precision, single-piece folding cartons ideal for pharmaceutical, cosmetics, and food packaging. Our cartons feature intricate die-cutting and high-end finishes like metallic foiling and UV spot coating for a premium shelf appeal.',
    images: [img1, img2, img3, img4],
    features: ['FDA Compliant Stock', 'Customizable Structures (e.g., lock-bottom)', 'Premium Finishing Options', 'High-Speed Automated Production'],
    applications: ['Pharmaceutical Blister Packs', 'Cosmetic Products', 'Small Electronics', 'Gourmet Food Items'],
    category: 'packaging',
    specifications: [
  ...
  'labels': {
    ...
    description: 'Durable, high-quality self-adhesive labels available in roll or sheet form. We offer a variety of paper and filmic substrates with strong, weather-resistant adhesives, perfect for product branding and regulatory compliance.',
    images: [img5, img6, img7, img8],
    features: ['Water & Oil Resistant Materials', 'Flexographic and Digital Printing', 'Variable Data & Barcoding', 'Custom Die-Cut Shapes'],
    applications: ['Bottle & Jar Labeling', 'Industrial Drum Labels', 'Logistics/Shipping Labels', 'Product Authentication Seals'],
    category: 'labels',
    specifications: [
  ...
  'leaflets': {
    ...
    description: 'Precisely folded, detailed leaflets and package inserts, critical for pharmaceuticals and consumer goods where clear, comprehensive information is required. Available in ultra-thin and miniature fold formats.',
    images: [img9, img10, img11, img12],
    features: ['Miniature and Perforated Folds', 'High-Clarity Text Reproduction', 'Compliant with Pharma Standards', 'Multiple Paper Stock Weights'],
    applications: ['Medical Prescription Inserts', 'Instruction Manuals (IFA)', 'Product Promotion Handouts', 'Warranty Cards'],
    category: 'marketing',
    specifications: [
  ...
  'corrugated-boxes': {
    ...
    description: 'Robust, multi-ply corrugated cardboard boxes built for shipping, storage, and heavy-duty product protection. Custom-engineered for stacking strength and cushioning during transit.',
    images: [img21, img22, img23, img24],
    features: ['High Bursting Strength (BF)', 'Custom Flute Types (E, B, C, EB)', 'Die-Cut Self-Locking Designs', 'Flexographic Printing for Branding'],
    applications: ['E-commerce Shipping Boxes', 'Bulk Industrial Goods', 'Display-Ready Packaging (RRP)', 'Gift & Subscription Boxes'],
    category: 'packaging',
    specifications: [
  ...
  'promotional-material': {
    ...
    description: 'Bespoke marketing and point-of-sale materials, including calendars, danglers, posters, and shelf talkers, designed to capture customer attention and drive sales in retail environments.',
    images: [img17, img18, img19, img20],
    features: ['Vibrant UV Printing', 'Durable Card Stock', 'Custom Die-Cutting for Unique Shapes', 'Integrated Easel/Stand Options'],
    applications: ['Retail Point-of-Sale (POS)', 'Corporate Calendars', 'Trade Show Giveaways', 'In-Store Signage & Danglers'],
...
const countPackaging = productCategories.filter(p => p.category === 'packaging').length; // 2
const countLabels = productCategories.filter(p => p.category === 'labels').length; // 1
const countMarketing = productCategories.filter(p => p.category === 'marketing').length; // 1
const countPromotional = productCategories.filter(p => p.category === 'promotional').length; // 1
